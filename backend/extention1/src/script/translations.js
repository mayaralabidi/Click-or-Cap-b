export const translations = {
  "en": {
    "background": {
      "contextMenu": {
        "addSelection": "Add selection to filter",
        "disableOnce": "Disable once",
        "options": "$t(common:names.options)",
        "removeSelection": "Remove selection from filter",
        "toggleAdvancedForDomain": "Toggle advanced for domain",
        "toggleForDomain": "Toggle for domain",
        "toggleForTab": "Toggle for tab",
        "toggleFramesForDomain": "Toggle frames for domain"
      },
      "updateNotification": {
    ...
    "common": {
      ...
      "values": {
        "defaultWordSubstitution": "censored",
    ...
    "options": {
      "bookmarkletsPage": {
        ...
        "notes": {
          "explanation": "Create a 'bookmarklet' of ClickorCap that can be used when you can't install the extension",
      ...
      "bulkWordEditorModal": {
        ...
        "tableHeaders": {
          "matchMethod": "$t(options:headers.matchMethod)",
          "remove": "Remove",
          "repeated": "Repeated",
          "separators": "Separators",
          "substitution": "$t(common:names.substitution)",
          "substitutionCase": "Substitution Case",
          "word": "$t(common:names.word)"
        }
      },
      "configsPage": {
        "buttons": {
      ...
      "domainsPage": {
        ...
        "options": {
          "addOrUpdateExistingDomain": "$t(options:options.addOrUpdateExisting)",
      ...
      "labels": {
        ...
        "matchRepeatedCharacters": "Match repeated characters",
        "matchSeparators": "Match separators"
      },
      "listsPage": {
        "buttons": {
          "addWordlist": "$t(common:buttons.add)",
          "removeWordFromList": "$t(common:buttons.remove)",
          "removeWordlist": "$t(common:buttons.remove)",
        ...
        "headers": {
          ...
          "wordPhrase": "$t(options:headers.wordPhrase)"
        },
        "labels": {
          "caseInsensitive": "$t(options:labels.caseInsensitive)",
          "caseSensitive": "$t(options:labels.caseSensitive)"
        },
        "messages": {
          "confirmRemoveWordlist": "Are you sure you want to remove this wordlist?",
        ...
        "notes": {
          "allowlistCaseSensitive": "(* $t(options:labels.caseSensitive))",
          "caseInsensitive": "(doghouse: Don't filter 'DogHouse')",
          "caseSensitive": "(Doghouse: Don't filter 'Doghouse')",
          "confirmRemoveWordlist": "Removes the wordlist from all assigned words too."
        },
        "options": {
          "addOrUpdateExistingWord": "$t(options:options.addOrUpdateExisting)",
          "addOrUpdateExistingWordlist": "$t(options:options.addOrUpdateExisting)",
          "allWordsWordlist": "$t(common:wordlists.allWords)"
        },
        "validations": {
          ...
          "wordPhraseInvalid": "$t(options:validations.wordPhraseInvalid)"
        }
      },
      "options": {
        "addOrUpdateExisting": "Add, or update existing..."
      },
      "passwordModal": {
        "buttons": {
      ...
      "settingsPage": {
        ...
        "options": {
          ...
          "originalCcensorFixedLength": "Original",
          "partialMatchMethod": "$t(common:wordMatchMethods.partial)",
      ...
      "tabs": {
        ...
        "config": "Config",
        "domains": "Domains",
        "help": "$t(common:names.help)",
        "lists": "Lists",
        "settings": "Settings",
        "stats": "Stats",
        "test": "Test",
        "words": "$t(common:names.words)"
      },
      "testsPage": {
        "headers": {
          "filtered": "Filtered",
      ...
      "wordsPage": {
        ...
        "labels": {
          ...
          "matchRepeated": "$t(options:labels.matchRepeatedCharacters)",
          "matchSeparators": "$t(options:labels.matchSeparators)"
        },
        "messages": {
        ...
        "notes": {
          ...
          "wordlistsGettingStarted": "Add a wordlist (Lists tab) to start using this feature"
        },
        "options": {
          "addOrUpdateExistingWord": "$t(options:options.addOrUpdateExisting)",
          "exactMatchMethod": "$t(common:wordMatchMethods.exact)",
    ...
    "popup": {
      ...
      "disabledMessages": {
        "disconnected": "Disconnected, please refresh page",
        "domain": "Popup disabled for domain",
        "domainMode": "Popup disabled by domain mode",
        "passwordProtected": "Popup disabled by password",
        "restrictedPage": "Popup disabled by browser",
        "tab": "Popup disabled for tab"
      },
      "domainModes": {
        "advanced": "$t(common:domainModes.advanced)",
        "deep": "$t(common:domainModes.deep)",
        "normal": "$t(common:domainModes.normal)"
      },
      "filterMethods": {
        "censor": "$t(common:filterMethods.censor)",
        "off": "$t(common:filterMethods.off)",
        "remove": "$t(common:filterMethods.remove)",
        "substitute": "$t(common:filterMethods.substitute)"
      },
      "footer": {
        "changelog": "$t(common:names.changelog)",
        "help": "$t(common:names.help)",
        "support": "$t(common:names.support)"
      },
      "labels": {
        "domainMode": "Mode",
        "filterMethod": "Filter",
      ...
      "wordlists": {
        "allWords": "$t(common:wordlists.allWords)",
        "default": "$t(common:wordlists.default)"
      }
    }
  }
};
